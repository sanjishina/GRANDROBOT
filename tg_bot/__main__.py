...
TECHNO_IMG = "https://telegra.ph/file/82189b0e7fdd17a58e560.jpgh"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/sparkysunny")],
                                                                                   [InlineKeyboardButton(text="ADD NINO TO YOUR GROUP",
        ...
        update.effective_message.reply_text("Hi,Im already Online kya~")
